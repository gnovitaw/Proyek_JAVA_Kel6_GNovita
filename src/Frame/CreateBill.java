...
public class CreateBill extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Detail Product");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill no", "Costumer Name", "Product Name", "Price Per Unit", "Quantity", "Total"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      ...
      jTextField3.setText(model.getValueAt( jTable1.getSelectedRow(), 2).toString());
       ...
       jTextField7.setText(model.getValueAt( jTable1.getSelectedRow(), 5).toString());
    ...
    public void billno()
 {
   ...
   ResultSet rs1;
    ...
    {
   String query="INSERT INTO `bill`(bno,`cname`,`product`,amt,`pdate`) VALUES("+jTextField1.getText()+",'"+jTextField2.getText()+"','"+jTextField3.getText()+"',"+jTextField7.getText()+",'"+jTextField8.getText()+"');";
