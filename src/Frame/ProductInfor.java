 ...
 * @author novitawg
 */
public class ProductInfor extends javax.swing.JInternalFrame {
    ...
    public ArrayList<Product> List(String ValToSearch)
    {
        ...
        try{
            ...
            while(rs.next())
            {
               product = new Product(rs.getString("id"), rs.getString("pname"),rs.getInt("available"),rs.getInt("mrp")
               ); 
               pro.add(product);
            }
    ...
    public void findproduct()
        {
            ...
            model.setColumnIdentifiers(new Object[]{"Product Id","Product Name","Available","Price per unit"});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Id", "Product Name", "Available", "Price per unit"
            }
        ));
