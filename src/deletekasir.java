...
public class deletekasir extends javax.swing.JFrame {

    /**
     * Creates new form deletekasir
     */
    public deletekasir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton_Register_.setText("Delete");
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        PreparedStatement ps;
          ...
          String query = "Delete from kasirlogin where username='"+uname+"'";    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deletekasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deletekasir().setVisible(true);
            }
        });
    }
