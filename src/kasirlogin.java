...
public class kasirlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Login Form Kasir");
    ...
    private void jLabelRegisterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelRegisterMouseClicked
        RegisterKasir rgf = new RegisterKasir();
        rgf.setVisible(true);
        rgf.pack();
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
       if(jTextField1.equals("") && jPasswordField1.equals("") )
       ...
       else
        {
                ...
                String query = "select * from kasirlogin where username='"+uname+"' and password='"+pass+"'";
       ...
       this.dispose();
                    ...
                    Logger.getLogger(kasirlogin.class.getName()).log(Level.SEVERE, null, ex);
                }
