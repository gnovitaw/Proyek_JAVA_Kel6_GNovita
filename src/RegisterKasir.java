...
public class RegisterKasir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Register Kasir");
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        String query = "Insert into kasirlogin (username, password) values (?,?)";
    ...
    public boolean checkUsername(String user1)
    {
        ...
        String query = "select * from kasirlogin where username='"+user1+"'";
